...
export function FeedbackDetail({ feedback }: { feedback: FeedbackDetailData }) {
  ...
  return <>
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
      <main className="grid gap-6"><section className={panelClass} aria-labelledby="feedback-message"><h2 className="text-lg font-bold" id="feedback-message">Message</h2><p className="mt-4 whitespace-pre-wrap break-words text-sm leading-7 text-body">{feedback.message}</p></section>
