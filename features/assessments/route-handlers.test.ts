...
const mocks = vi.hoisted(() => ({
  resolveRequestIdentity: vi.fn(), startAssessment: vi.fn(), submitAttempt: vi.fn(), updateAttemptAnswer: vi.fn(),
}));
...
vi.mock("./service", () => ({
  ...
  getAttempt: vi.fn(), getAttemptResult: vi.fn(), retakeAttempt: vi.fn(), listAttempts: vi.fn(),
}));

import { assessmentStartHandler, attemptAnswerHandler, attemptSubmitHandler } from "./route-handlers";
