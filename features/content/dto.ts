...
export function organSystemDto(value: OrganSystem, admin = false) {
...
export function topicDto(value: Topic, admin = false) {
...
export function lessonDto(value: ContentLesson, admin = false) {
